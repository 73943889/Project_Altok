...
export const HowItWorks = () => {
  return (
    <section id="como-funciona" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/40">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
            ¿Cómo funciona <span className="text-emerald-400">Altok€</span>?
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            Envía dinero de España y Estado Unidos a Perú de forma rápida, segura y con la tasa real del mercado en solo 3 simples pasos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-950/60 border border-slate-800 p-8 rounded-2xl relative shadow-xl hover:border-emerald-500/50 transition-all group">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Transfiere desde tu cuenta bancaria en España o Estado Unidos hacia nuestra cuenta corporativa aliada y enviamos tu comprobante de pago de forma segura por nuestro canal de Whatssap.
            </p>
          </div>
